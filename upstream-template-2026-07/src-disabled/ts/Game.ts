...
export class Game {
    public bga: Bga<CardSpicePlayer, CardSpiceGamedatas>;
    private gamedatas: CardSpiceGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<CardSpicePlayer, CardSpiceGamedatas>) {
        console.log('cardspice constructor');
        this.bga = bga;
    ...
    */
    ...
    setup(gamedatas: CardSpiceGamedatas) {
